...
def registerDevice():
    if request.method == "POST":
        ...
        post = {"uid": uid, "ownerType": ownerType, "fArray": [], "address": address, "owner": owner,
                "activeDate": activeDate, "type": type_of_device, "settings": "15", "activeState": 0, "deviceState": 0, "mode": 0}
